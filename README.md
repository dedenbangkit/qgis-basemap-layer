...
## Import basemap Layer to QGIS

- In your QGIS window, go to `Plugins > Python Console`.
- Paste the following code to the console panel then run it.
...
- Open Browser panel `Panels > Browser`.
